...
|   `NAPCAT_URL`    |                                  本地 NapCat QQ 通知                                 | OneBot HTTP 地址，例如 `http://127.0.0.1:3000`，与 `NAPCAT_TOKEN`、`NAPCAT_QQ` 同时填写 |
| `NAPCAT_TOKEN`    |                                  本地 NapCat QQ 通知                                 | NapCat OneBot HTTP token |
|   `NAPCAT_QQ`     |                                  本地 NapCat QQ 通知                                 | 接收中奖通知的 QQ 号 |
